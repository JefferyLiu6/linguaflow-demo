 ...
 *
 * Hand-tagged mapping from DrillItem.id → list of taxonomy labels.
 * MUST stay in sync with agent/planner/taxonomy.py — the labels and IDs
 * are identical on both sides; the dashboard renders these labels and
 * the planner reasons about them.
 *
 * A drill may carry multiple labels (e.g., a transformation drill that
 * also targets formal register).
 */
...
export const TAXONOMY_LABELS: readonly TaxonomyLabel[] = [
  'formal_register',
  'advanced_synonym_precision',
  'single_precise_verb',
  'sentence_transformation',
...
export const TAXONOMY_DISPLAY: Record<TaxonomyLabel, string> = {
...
/** id → labels[]. Drills not present here have no taxonomy assignment. */
export const ENGLISH_TAXONOMY: Record<string, readonly TaxonomyLabel[]> = {
  ...
  // ── DB_EN_VOCAB ────────────────────────────────────────────────────────────
  en_v1:  ['topic_specific_vocab', 'advanced_synonym_precision'],
  en_v2:  ['topic_specific_vocab', 'advanced_synonym_precision'],
  en_v3:  ['topic_specific_vocab', 'advanced_synonym_precision'],
  en_v4:  ['topic_specific_vocab', 'advanced_synonym_precision'],
  en_v5:  ['topic_specific_vocab', 'advanced_synonym_precision'],
  en_v6:  ['topic_specific_vocab', 'advanced_synonym_precision'],
  en_v7:  ['topic_specific_vocab', 'advanced_synonym_precision'],
  en_v8:  ['topic_specific_vocab', 'advanced_synonym_precision'],
  en_v9:  ['topic_specific_vocab', 'advanced_synonym_precision'],
  en_v10: ['topic_specific_vocab', 'advanced_synonym_precision'],
  en_v11: ['topic_specific_vocab', 'advanced_synonym_precision'],
  en_v12: ['topic_specific_vocab', 'advanced_synonym_precision'],
  en_v13: ['topic_specific_vocab', 'advanced_synonym_precision'],
  en_v14: ['topic_specific_vocab', 'advanced_synonym_precision'],
  en_v15: ['topic_specific_vocab', 'advanced_synonym_precision'],

  // ── DB_EN_PHRASES ──────────────────────────────────────────────────────────
  en_p1:  ['phrase_idiom', 'formal_register'],
  en_p2:  ['phrase_idiom', 'formal_register'],
  en_p3:  ['phrase_idiom', 'formal_register'],
  en_p4:  ['phrase_idiom', 'formal_register'],
  en_p5:  ['phrase_idiom', 'formal_register'],
  en_p6:  ['phrase_idiom', 'formal_register'],
  en_p7:  ['phrase_idiom', 'formal_register'],
  en_p8:  ['phrase_idiom', 'formal_register'],
  en_p9:  ['phrase_idiom', 'formal_register'],
  en_p10: ['phrase_idiom', 'formal_register'],
...
export function labelsForId(id: string): readonly TaxonomyLabel[] {
  return ENGLISH_TAXONOMY[id] ?? []
}
